...
#############################################################
            ...
            if reduction == 'PCA':
                if map_file == 'noise':
                    self.indir= m2dir+"AGBT17_Products/2XMM/"
                    #self.fitsfile=self.indir+"Kelvin_2XMMJ0830+5241_2aspix__map_iter1.fits"
                    self.fitsfile=self.indir+"Kelvin_2XMMJ0830+5241_2aspix_pca3_0f05_v1_noise_iter1.fits"
                if map_file == 'all':
                    self.indir= m2dir+"AGBT17_Products/2XMM/"
                    #self.fitsfile=self.indir+"Kelvin_2XMMJ0830+5241_2aspix__map_iter1.fits"
...
class priors:
    ...
    def __init__(self):
        ...
        self.z=0.99                           # Redshift
        #self.ra = Angle('02h21m45.184s')     # Right Ascencion, in hours
        #self.dec= Angle('-03d46m14.94s')     # Declination, in degrees
        #####################################################################
        #self.ra = Angle('08h30m23.248s')      # Right Ascencion, in hours
        #self.dec= Angle('+52d41m51.55s')      # Declination, in degrees
        self.ra = Angle('08h30m26.058s')      # Right Ascencion, in hours
        self.dec= Angle('+52d41m37.01s')      # Declination, in degrees
        self.M_500 = 8.0e14                   # Solar masses
        self.Tx    = 7.6                      # keV
        self.name  = '2XMM'
...
class private_vars:
    ...
    def __init__(self):
        ...
        RXJ1347_ra    = Angle('08h30m23.248s'); RXJ1347_dec    = Angle('+52d41m51.55s')
